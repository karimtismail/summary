...
export const studyTracks: StudyTrack[] = [
  {
    ...
    phases: [
      ...
      },
      {
        phase: "Netty core",
        label: "Netty runtime",
        outcome: "Understand how Netty moves work through EventLoops, ByteBufs, futures, pipelines, and handlers.",
    ...
    steps: [
      ...
      { section: "java-nio", slug: "buffers", phase: "Java NIO bridge", reason: "Understand byte staging before channels move data through it.", checkpoint: "You can explain reader/writer memory flow." },
